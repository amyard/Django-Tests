...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_ingredients(self):
        ingredients1 = sample_ingredient(user = self.user, name = 'BLa')
        ingredients2 = sample_ingredient(user=self.user, name='BLo')
        payload = {
            'title': 'Some food',
